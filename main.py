...
if __name__ == "__main__":
    data_module = AncientPairDataModule(batch_size=180, data_dir="/home/featurize/data/dataset")
    ...
    trainer = pl.Trainer(logger=neptune_logger, gpus=1, precision=16, log_every_n_steps=1, default_root_dir="checkpoints")
